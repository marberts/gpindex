...
A small R package for calculating lots of different price and quantity indexes. Provides tools to build and work with any type of generalized bilateral index (of which most price and quantity indexes are), along with a few important indexes that don't belong to the generalized family. 
